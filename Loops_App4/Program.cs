// jump deyimleri;
// continue : döngü içeriisnde kullanılır. döngü ile continue komutu arası kodlar tekrar çalıştırılır. Yani continue komutu execute edilirken döngü koşulana tekrar dönüşür..yani koşul ifadesini tekrar çalışrırır.
